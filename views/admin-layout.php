...
<meta charset="UTF-8">
    ...
    <title>Registro - <?php echo $titulo; ?></title>
    <link rel="icon" href="/build/img/icon/llave-inglesa.png" type="image/png">
...
<body class="dashboard">
    ...
    <script src="/build/js/datatables-simple-demo.js"></script>
